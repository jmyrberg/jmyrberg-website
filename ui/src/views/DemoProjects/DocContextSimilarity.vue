<template>
  <DemoProjectTemplate header="Document Context Similarity">
    <template v-slot:description>
      <p>
        Recent years have shown tremendous progress in Natural Language Processing (NLP). <a href="https://ai.googleblog.com/2018/11/open-sourcing-bert-state-of-art-pre.html" target="_blank">Google's BERT</a> is a neural network based NLP model, for which <a href="https://turkunlp.org/" target="_blank">Turku NLP group</a> has trained a Finnish version called <a href="https://github.com/TurkuNLP/FinBERT" target="_blank">FinBERT</a>.
      </p>
      <p>
